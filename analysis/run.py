...
if __name__ == "__main__":
    ...
    if not(result_same_rec or result_diff_rec or result_sent):
        print("""
        Unfortunately, it appears the song you selected is either too small or recent to be in my database.
        Spotify has deprecated their API endpoints, so now projects for the same purposes and upheld by small, often unpaid teams.
